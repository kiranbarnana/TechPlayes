...
//    UO_align_oc_msg_colon,
   ...
   UO_disable_processing_cmt,   // override TechPlayers_DEFAULT_OFF_TEXT
   UO_enable_processing_cmt,    // override TechPlayers_DEFAULT_ON_TEXT
...
{
   TechPlayers_groups        id;
   const char               *short_desc;
   const char               *long_desc;
   list<TechPlayers_options> options;
};

struct option_map_value
{
   TechPlayers_options id;
   TechPlayers_groups  group_id;
   argtype_e          type;
   int                min_val;
   int                max_val;
   const char         *name;
...
typedef map<TechPlayers_groups, group_map_value>::iterator   group_map_it;
typedef list<TechPlayers_options>::iterator                  option_list_it;
typedef list<TechPlayers_options>::const_iterator            option_list_cit;
