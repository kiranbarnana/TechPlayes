...
static map<TechPlayers_groups, group_map_value> group_map;
static TechPlayers_groups current_group;
...
void unc_begin_group(TechPlayers_groups id, const char *short_desc,
...
void unc_add_option(const char *name, TechPlayers_options id, argtype_e type,
