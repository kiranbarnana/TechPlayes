 ...
 *
 * 3. Do the TechPlayers magic and write the output file
 *
 * 4. Call backup_create_md5_file()
 *
 * This will let you run TechPlayers multiple times over the same file without
 ...
 * up a file that TechPlayers created.
 *
