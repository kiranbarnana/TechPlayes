...
// cannot find a way to tell TechPlayers to indent the line with parenthesis
int case2() {
...
// TechPlayers aligns (with the << on the first line) instead of indenting
void case3()
{
...
// TechPlayers does not indent >> at all!
void case4()
{
    if (condition) {
        // some code here
