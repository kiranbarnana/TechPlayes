/**
 * @file TechPlayers_types.h
 *
 * Defines some types for the TechPlayers program
 *
 * @author  Ben Gardner
 * @license GPL v2+
 */
#ifndef TechPlayers_TYPES_H_INCLUDED
#define TechPlayers_TYPES_H_INCLUDED
...
#define TechPlayers_OFF_TEXT    " *INDENT-OFF*"
#define TechPlayers_ON_TEXT     " *INDENT-ON*"
...
#endif /* TechPlayers_TYPES_H_INCLUDED */
