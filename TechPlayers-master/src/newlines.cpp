...
static void _blank_line_set(chunk_t *pc, const char *text, TechPlayers_options uo)
{
   LOG_FUNC_ENTRY();
...
static void _blank_line_max(chunk_t *pc, const char *text, TechPlayers_options uo)
{
   LOG_FUNC_ENTRY();
   if ((cpd.settings[uo].n > 0) && (pc->nl_count > cpd.settings[uo].n))
   {
